...
class Client(object):
    """Define o comportamento de um cliente no ambiente federado."""
    def __init__(self, net_client_model, idx, lr, device, idxs=None, idxs_test=None):
        ...
        # --- CORREÇÃO AQUI ---
        # Cria o dataset do cliente a partir do FULL_DATASET original,
        # usando os índices específicos que este cliente recebeu.
        # O CustomDataset garante que a transformação correta seja aplicada.
